  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <div className="mb-10 pb-8" style={{ borderBottom: "2px solid var(--foreground)" }}>
        <p className="font-display text-[10px] tracking-[0.3em] mb-3" style={{ color: "var(--brand)" }}>LEGAL</p>
        <h1 className="font-serif text-4xl font-bold" style={{ color: "var(--foreground)" }}>プライバシーポリシー</h1>
        <p className="font-display text-[10px] tracking-wider mt-3" style={{ color: "var(--muted)" }}>
          最終更新日：2025年1月1日
        </p>
      </div>
      ...
      <div className="prose-article">
        ...
        <h2>5. 第三者への提供</h2>
        <p>当サイトは、法令に基づく場合を除き、収集した個人情報を第三者に提供・開示しません。</p>
        <h2>6. 個人情報の管理</h2>
        <p>当サイトは、収集した個人情報の漏洩・紛失・改ざん等を防止するため、適切なセキュリティ対策を講じます。</p>
        <h2>7. お問い合わせ</h2>
        <p>本プライバシーポリシーに関するお問い合わせは、お問い合わせフォームよりご連絡ください。</p>
        <h2>8. ポリシーの変更</h2>
        <p>当サイトは、必要に応じて本プライバシーポリシーを変更することがあります。変更後のポリシーは、本ページに掲載した時点で効力を生じるものとします。</p>
      </div>
    </div>
  );
}
