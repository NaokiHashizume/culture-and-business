...
export const metadata: Metadata = {
  title: "About",
  description: "Culture & Business について。歴史と美術の知恵をビジネスに活かすメディアのコンセプトと運営者について。",
};
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <div className="mb-10 pb-8" style={{ borderBottom: "2px solid var(--foreground)" }}>
        <p className="font-display text-[10px] tracking-[0.3em] mb-3 text-brand">ABOUT</p>
        <h1 className="font-serif text-5xl font-bold text-fg">About</h1>
        <p className="font-display text-[11px] tracking-wider mt-3 text-muted-var">
          CULTURE &amp; BUSINESS について
        </p>
      </div>
      ...
      <div className="prose-article">
        ...
        <h2>コンセプト</h2>
        <p>私たちは以下のテーマを中心に、独自の視点で記事をお届けします。</p>
        <ul>
      ...
      <div className="mt-12 pt-8 flex gap-4 flex-wrap" style={{ borderTop: "1px solid var(--border-soft)" }}>
        <Link href="/contact" className="btn-brand">CONTACT</Link>
        <Link href="/articles" className="btn-outline">ARTICLES</Link>
      </div>
    </div>
  );
}
